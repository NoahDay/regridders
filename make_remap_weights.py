...
def find_grid_defs(input_dir, jra55_input, core_input):
    ...
    d = {}
    d['MOM1'] = (os.path.join(input_dir, 'ocean_grid_10.nc'),
                 os.path.join(input_dir, 'om2_1deg_basinmask_yt_xt.nc'))
    d['MOM025'] = (os.path.join(input_dir, 'ocean_grid_025.nc'),
                   os.path.join(input_dir, 'om2_p25deg_basinmask_yt_xt.nc'))
    d['MOM01'] = (os.path.join(input_dir, 'ocean_grid_01.nc'),
                  os.path.join(input_dir, 'mom_01deg', 'om2_p1deg_basinmask_yt_xt.nc'))
...
def main():
    ...
    ocean_options = ['MOM025'] #['MOM1', 'MOM025', 'MOM01']
    ...
    if args.ocean is None:
        ...
        if args.ocean not in ocean_options:
            print("Error: bad ocn grid.", file=sys.stderr)
            parser.print_help()
            return 1
